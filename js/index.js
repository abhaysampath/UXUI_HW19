...
$(".openDesktopPrototype1").on("click", function(){
    ...
    $(".openDesktopPrototype1").fadeTo("slow", 0.1);
...
$(".openMobilePrototype1").on("click", function(){
    ...
    $(".openMobilePrototype1").fadeTo("slow", 0.1);
